...
use Tempest\View\ViewRenderer as TempestViewRendererInterface;
use Throwable;

/**
 * This is a one to one copy of \Tempest\View\Renderers\TempestViewRenderer
 * with the only change being the removal of ViewCompilationFailed exception throwing
 * in favor of re-throwing the original exception for Kirby Whoops debugger.
 */

final class Renderer implements TempestViewRendererInterface
{
